...
CREATE TYPE public.order_status AS ENUM ('pending', 'preparing', 'complete', 'cancelled');
...
CREATE TABLE public.products (
  ...
  sugar_levels TEXT[] DEFAULT ARRAY['0%','25%','50%','75%','100%'],
  ice_levels TEXT[] DEFAULT ARRAY['No Ice','Less Ice','Regular','Extra Ice'],
